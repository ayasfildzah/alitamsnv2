...
class laporansurvey extends StatefulWidget {
  const laporansurvey({Key? key}) : super(key: key);

  @override
  _laporansurveyState createState() => _laporansurveyState();
}

class _laporansurveyState extends State<laporansurvey> {
  ...
  Future upload(File imageFile) async {
    ...
    request.fields['visit_log[work_place_id]'] = "1602";
    ...
    if (response.statusCode == 200) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => HomeSurvey()),
      );
