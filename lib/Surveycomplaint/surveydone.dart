...
class surveydone extends StatefulWidget {
  const surveydone({Key? key}) : super(key: key);

  @override
  _surveydoneState createState() => _surveydoneState();
}

class _surveydoneState extends State<surveydone> {
  ...
  void navigationPage() {
    Navigator.pushReplacement(
        context, new MaterialPageRoute(builder: (context) => HomeSurvey()));
  }
