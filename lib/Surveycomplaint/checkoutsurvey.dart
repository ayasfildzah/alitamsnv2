...
class checkoutsurvey extends StatefulWidget {
  @override
  _checkoutsurveyState createState() => _checkoutsurveyState();
}

class _checkoutsurveyState extends State<checkoutsurvey> {
  ...
  Future<List<Datacheckout>?> Updatedata({required String id}) async {
    final prefs = await SharedPreferences.getInstance();
    office = prefs.getString("location")!;
