...
class HomeWfh extends StatefulWidget {
  const HomeWfh({Key? key}) : super(key: key);

  @override
  _HomeWfhState createState() => _HomeWfhState();
}

class _HomeWfhState extends State<HomeWfh> {
  int _currenIndex = 0;
  final tabs = [
    Center(child: Dashboardwfh()),
