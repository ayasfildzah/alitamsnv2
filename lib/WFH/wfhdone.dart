...
class wfhdone extends StatefulWidget {
  const wfhdone({Key? key}) : super(key: key);

  @override
  _wfhdoneState createState() => _wfhdoneState();
}

class _wfhdoneState extends State<wfhdone> {
  ...
  void navigationPage() {
    Navigator.pushReplacement(
        context, new MaterialPageRoute(builder: (context) => HomeWfh()));
  }
