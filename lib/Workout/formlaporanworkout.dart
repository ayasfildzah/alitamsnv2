...
class laporanworkoutside extends StatefulWidget {
  const laporanworkoutside({Key? key}) : super(key: key);

  @override
  _laporanworkoutsideState createState() => _laporanworkoutsideState();
}

class _laporanworkoutsideState extends State<laporanworkoutside> {
  ...
  Future upload(File imageFile) async {
    ...
    request.fields['visit_log[work_place_id]'] = "1603";
    ...
    if (response.statusCode == 200) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => HomeWorkout()),
      );
