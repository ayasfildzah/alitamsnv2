...
class checkoutwfh extends StatefulWidget {
  @override
  _checkoutwfhState createState() => _checkoutwfhState();
}

class _checkoutwfhState extends State<checkoutwfh> {
                                  ...
                                  child: Column(children: [
                                    ...
                                    MaterialButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        preferences.remove("latitude_user");
  ...
  Future<List<Datacheckout>?> Updatedata({required String id}) async {
    final prefs = await SharedPreferences.getInstance();
    office = prefs.getString("latitude_user")!;
